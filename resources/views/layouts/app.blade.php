        ...
        <div class=" add-idea-container bg-white border-2 border-blue rounded-xl mt-16">
            ...
            <form action="#" method="POST" class="space-y-4 px-4 py-6" >
                ...
                <div class="flex items-center justify-between space-x-3">
                    ...
                    <button type="submit" class="flex items-center justify-center w-1/2 h-11 text-xs bg-blue border-2  font-semibold border-blue text-white hover:bg-blue-hover transition duration-200 ease-in rounded-xl px-4 py-3">
